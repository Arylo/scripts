...
import { defineComponent, h, onMounted, unref } from '@scripts/gm-vue'
      ...
      h(
        'div',
        {
          ...
          class: cc([
            ...
            {
              'cursor-pointer':
                unref(mouseTypeRef) === GRID_CELL_TYPE.PREV ||
                unref(mouseTypeRef) === GRID_CELL_TYPE.NEXT,
            },
          ]),
        },
        [
          h(
            ...
            unref(imagesRef).map(({ component, props }) =>
              h(
                'div',
                {
                  class: cc([
                    ...
                    {
                      hidden:
                        unref(directionModeRef) === DirectionMode.TTB && component === WhitePage,
                    },
                  ]),
                  ...Object.fromEntries(

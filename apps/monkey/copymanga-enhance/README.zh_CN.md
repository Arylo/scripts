...
[github-last-update]: https://img.shields.io/github/last-commit/arylo/scripts/monkey?path=copymanga-enhance.user.js&style=flat-square&cacheSecond=7200&label=Last%20Update
...
[install_github]: https://raw.githubusercontent.com/Arylo/scripts/monkey/copymanga-enhance.user.js
[install_greasyfork]: https://update.greasyfork.org/scripts/567817/Enhance%20the%20copy%20manga%20site.user.js

## 简介

对开布局、支持带鱼屏、自适应图片高度、快捷翻页、支持键盘操作。
